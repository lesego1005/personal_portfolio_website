...
My capstone—a cloud-deployed AI-enhanced data pipeline—combined all domains: AI for code generation (Week 2), Power BI dashboard (Weeks 3/7), Python ETL to Azure SQL (Week 4), deployment on Azure Functions with security (Weeks 5-6), and Docker/CI/CD (Week 7). Agile planning (Week 1) guided iterations. It demonstrated interconnected tech, evaluated via demo and docs.

## My Goals Moving Forward
Specialise in Data Engineering post-bootcamp. Achieve AWS CCP and AZ-900 certifications. Build GitHub portfolio, network via CAPACITI events, and aim for a junior data engineer role by program end. Explore advanced AI in data ethically.